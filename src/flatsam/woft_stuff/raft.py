...
from flatsam.utils.misc import torch_get_featuremap_coords, get_featuremap_coords

from flatsam.woft_stuff.raft_core.raft import RAFT
from flatsam.woft_stuff.raft_core.weighted_raft import WeightedRAFT
from flatsam.woft_stuff.raft_core.utils.utils import InputPadder
...
class RAFTWrapper():
    def __init__(self, config):
        ...
        state_dict = torch.load(self.C.model, weights_only=True)
